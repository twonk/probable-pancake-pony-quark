...
/*
	(function updatePhotoOrig()
	{
		if(photoCounter>5)photoCounter=0;
		photoCounter=photoCounter+1;
		//$('.photo').prepend('<img id="theImg" src="photo'+photoCounter+'.jpg" />');
		var img = document.createElement("IMG");
		img.src = "photos/photo"+photoCounter+".jpg";
		//img.height = "300";
...
*/
	...
	(function updatePhoto()
	{
		...
		//$('.photo').prepend('<img id="theImg" src="photo'+photoCounter+'.jpg" />');
		var img = document.createElement("IMG");
		img.src = "photos/photo"+photoCounter+".jpg?cached="+Date.now();
		//img.height = "300";
		img.className="picture";
	...
	(function updateCurrentWeather()
	{
		...
		$.getJSON('https://api.openweathermap.org/data/2.5/weather', weatherParams, function(json, textStatus) {
	...
	(function updateWeatherForecast()
	{
		var iconTable = {
			...
			$.getJSON('https://api.openweathermap.org/data/2.5/forecast', weatherParams, function(json, textStatus) {
